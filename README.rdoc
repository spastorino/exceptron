...
When using bundler, add it got your Gemfile:
...
Auto reloading does not work for the ExceptionsController. In case of any changes you have to restart the webserver.
